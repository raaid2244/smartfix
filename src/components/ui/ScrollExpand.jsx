...
const ScrollExpand = ({
  ...
  const applyProgress = useCallback(p => {
    ...
    if (overlayRef.current) {
      const inn = smoothstep(0.05, 0.4, p);
  ...
  const media = mediaComponent ? (
    <div ref={mediaRef} className="scroll-expand__media w-full h-full">
      {mediaComponent}
    </div>
  ) : src ? (
    mediaType === 'video' ? (
    ...
    <div ref={mediaRef} className="scroll-expand__media bg-slate-900" />
  );
      ...
      <div ref={trackRef} className="scroll-expand__track">
        <div ref={stageRef} className="scroll-expand__stage">
          <div ref={frameRef} className="scroll-expand__frame">
            ...
            {children ? (
              <div ref={overlayRef} className="scroll-expand__overlay pointer-events-none">
                {children}
              </div>
            ) : null}
          </div>
